...
//					console.log(resultData);
					...
					for(var i = 0; i < resultDataArr.length; i++) {
						strData += '<li>' +
							...
							'	<div class="item-inner" id="snapShotDetail_0">' +
							'		<div class="item-title">' + btnInfoNames[i] + '</div>' +
							'		<div class="item-after"><span class="badge">' + resultDataArr[i] + '</span></div>' +
							'	</div>' +
							'</a>' +
							'</li>';
					}
